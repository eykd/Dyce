...
def after_install(options, home_dir):
    ...
    subprocess.call([join(bin_dir, 'easy_install'), 'epydoc'])
    subprocess.call([join(bin_dir, 'easy_install'), 'sphinx'])
    subprocess.call([join(bin_dir, 'easy_install'), 'nose'])
    subprocess.call([join(bin_dir, 'easy_install'), 'testoob'])
    subprocess.call([join(bin_dir, 'easy_install'), 'ipython'])
    subprocess.call([join(bin_dir, 'easy_install'), 'pyflakes'])
    subprocess.call([join(bin_dir, 'paver'),'_virtualenv_post'])
